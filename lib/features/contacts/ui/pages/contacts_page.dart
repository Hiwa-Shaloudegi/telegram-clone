...
import 'package:telegram_clone/features/contacts/ui/widgets/contacts_app_bar.dart';
...
class _ContactsPageState extends ConsumerState<ContactsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: ContactsAppBar(extra: widget.extra),
      floatingActionButton: Consumer(
        builder: (context, ref, _) {
          return Visibility(
            visible: !ref.watch(isSelectionModeProvider),
